...
-- 7
-- SQL вернет нам те поля где зп в диапазоне между больше 10000 и меньше либо равно 10000
-- 8
-- SQL вернет нам те поля где зп в диапазоне между больше 10000 и меньше 10000
